...
<template>
  ...
  <div class="retro-window w-4/5 m-auto flex flex-col p-5 gap-4">
    <!-- Search bar-->
    <div class="flex flex-row comic-neue items-stretch">
      <input
        class="flex-1 border bg-[#bfedef] pt-0.5 pb-0.5 pr-2 pl-2"
        type="text"
        placeholder="search..."
      />
      <button
        class="bg-[#F4B5EA] text-[#98518E] border-l-0 border border-black hover:bg-[#e6a7dc] active:bg-[#d496ca] pt-0.5 pb-0.5 pl-1.5 pr-1.5 md:pl-5 md:pr-5 hover:cursor-pointer"
      >
        search
      </button>
    </div>
